        ...
        <footer className="bg-muted py-12 mt-20 border-t border-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="flex justify-center space-x-6 mb-8">
                    <a href="https://github.com/PRERNASONI2000" className="text-muted-foreground hover:text-primary-600 dark:hover:text-primary-500 transition-colors">
                        <span className="sr-only">GitHub</span>
                        <Github size={24} className="transition-transform duration-300 hover:scale-125 hover:-translate-y-1" />
                    </a>
                    <a href="https://www.linkedin.com/in/prerna-soni-472a9323a" className="text-muted-foreground hover:text-primary-600 dark:hover:text-primary-500 transition-colors">
                    ...
                    <a href="mailto:prernasoni2000@gmail.com" className="text-muted-foreground hover:text-primary-600 dark:hover:text-primary-500 transition-colors">
